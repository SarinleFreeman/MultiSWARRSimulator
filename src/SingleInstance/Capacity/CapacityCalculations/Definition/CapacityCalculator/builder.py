...
from src.SingleInstance.Capacity.CapacityCalculations.PC.definition import PCCapacityCalculator
from src.SingleInstance.Capacity.CapacityCalculations.STM.definition import STMCapacityCalculator
